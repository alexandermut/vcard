                        ...
                        <div className="space-y-6">
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-5 space-y-1 text-sm">
                                    ...
                                    <li><strong>Cookies & Login:</strong> Wenn Sie sich mit Ihrem Google-Konto verbinden, werden von Google Cookies gesetzt, um den Anmeldevorgang zu ermöglichen und Ihre Sitzung zu verwalten. Dies ist technisch notwendig und erfolgt direkt auf den Servern von Google (Google-Domain), nicht durch unseren Programmcode.</li>
