...
import { parseVCard } from '../utils/vcardUtils';
...
const handleSaveToGoogle = async (item: HistoryItem) => {
  ...
  try {
    const vcardData = parseVCard(item.vcard);
    const googlePerson = mapVCardToGooglePerson(vcardData);
